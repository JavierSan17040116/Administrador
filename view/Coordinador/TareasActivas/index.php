...
<body>
  ...
  <div class="barra">
    ...
    <a class="apartados" href="../ListadoTareas/index.php?id_user=<?php echo intval($_GET['id_user']) ?>">Listado de Tareas</a><br>
    <a class="apartados" href="#" style="pointer-events: none; color: grey;">Tareas Activas</a><br>
